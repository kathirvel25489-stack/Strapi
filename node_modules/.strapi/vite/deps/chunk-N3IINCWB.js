import {
  ...
  HOOKS
} from "./chunk-A7XS6W2V.js";
import {
  useNpsSurveySettings
} from "./chunk-YT3VJ2ZV.js";
import {
  require_pick
} from "./chunk-NGF4A6BV.js";
import {
  GuidedTourContext,
  useAIAvailability
} from "./chunk-PRAZJ7PG.js";
import {
  useGetAIUsageQuery
} from "./chunk-XWL66ND3.js";
import {
  _setPrototypeOf
...
import {
  ...
  require_merge,
  require_omit
} from "./chunk-ZIHUIDRX.js";
import {
  require_baseRest
} from "./chunk-OCDF7TB2.js";
import {
  HistoryProvider
} from "./chunk-JB7WHMLV.js";
import {
  useEnterprise
} from "./chunk-5ZB5LZ2K.js";
import {
  getBasename
} from "./chunk-TKXHHSNW.js";
import {
  useClipboard
} from "./chunk-LUF3Z6OD.js";
import {
  ADMIN_PERMISSIONS_EE,
  AUDIT_LOGS_DEFAULT_PAGE_SIZE,
  getEERoutes
} from "./chunk-OHAQLCYD.js";
import {
  Layouts
} from "./chunk-CGQ2GLDK.js";
import {
  Login
} from "./chunk-RMWEQCAI.js";
import {
  errorsTrads
...
import {
  ...
  create4 as create2,
  create6 as create3
} from "./chunk-QHVOD5QM.js";
import {
  MemoizedInputRenderer
} from "./chunk-AJ4GOLFE.js";
import {
  Form
} from "./chunk-3XSXUAQE.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-CRK2CJRA.js";
import {
  ConfigurationProvider
} from "./chunk-EUFHHPIF.js";
import {
  TrackingProvider,
  useTracking
} from "./chunk-DWEMJ5E6.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-4X2DTY7C.js";
import {
  getByteSize
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-K6L4QAFU.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-MWLIBGU5.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-UKG3XFFE.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-V7ENY4IT.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-6VXYOFYV.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-WQJBCAYP.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-ZSD7XX3V.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-4BPHL74D.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-4UDJ2BWC.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-VC7FGXC4.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-Z7G5AC3H.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-M7Z53QWT.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-RF5BNLWO.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-LQBEAMJD.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-IYPTGO5A.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-ROLJY3BH.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-N2AVN7SG.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-XW55PKXK.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-ZRD6D2LD.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-EV7OBONI.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-CDITX3GS.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-USVHVDT7.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-FAHP4ANL.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-RVWUZAQS.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-4P7VKZOT.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-U4OWHFAN.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-KHKPIT5O.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-SUOA3KL7.js");
              return {
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-2FTQIDP4.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-2FTQIDP4.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-3PJQYB74.js");
...
//# sourceMappingURL=chunk-N3IINCWB.js.map

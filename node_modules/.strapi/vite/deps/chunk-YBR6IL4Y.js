...
import {
  LimitsModal
} from "./chunk-GJ2R43C5.js";
import {
  AssigneeColumn,
  StageColumn,
  getDisplayName
} from "./chunk-I5SEJHXC.js";
import {
  getStageColorByHex
} from "./chunk-I5D5WOU4.js";
import {
...
} from "./chunk-XLXBEGIU.js";
import {
  index
} from "./chunk-WHDQW6WA.js";
import {
...
} from "./chunk-63MIAAM7.js";
import {
  useConfig
} from "./chunk-FCYBK2M3.js";
import {
  AssetSource,
  AssetType,
...
import {
  useDocumentActions
} from "./chunk-MAREVSIF.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-HK2WW6JS.js";
import {
  renderAdmin
...
import {
  useLicenseLimits
} from "./chunk-SXQWA4YP.js";
import {
  Table,
  useTable
} from "./chunk-Z6GRLTLG.js";
import {
  useAdminUsers
} from "./chunk-AECMRIU6.js";
import {
  create3 as create,
  create4 as create2,
  create6 as create3,
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-CZUQDBM3.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-AFFJFRST.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => {
        return import("./App-OT62TWYS.js").then((mod) => ({
          default: mod.Upload
        }));
      },
      position: 4
    ...
    if (window.strapi.future.isEnabled("unstableMediaLibrary")) {
      ...
      app.addMenuLink({
        ...
        permissions: PERMISSIONS3.main,
        Component: () => {
          return import("./App-B62QT3KD.js").then((mod) => ({
    ...
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-M5VDMTAJ.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-FANL2UCJ.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-2R7X43N3.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-Y54UBK6Z.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-XLIBET23.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-NVP7LLUI.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-U7BU3RRX.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-H5U35LDU.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-CBUIEWAN.js");
          return {
...
//# sourceMappingURL=chunk-YBR6IL4Y.js.map
